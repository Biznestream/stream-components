export const SHORTTEXT_TYPE = 'short-text';
...
export const ALL_ATTRIBUTE_TYPES = [
  ...
  { key: PARAGRAPH_TYPE, title: 'Paragraph' },
  { key: DROPDOWN_TYPE, title: 'Drop-down' },
  { key: MULTISELECT_TYPE, title: 'Multi-Select' },
  { key: DATETIME_TYPE, title: 'Date' },
  { key: NUMBER_TYPE, title: 'Number (Integer)' },
  { key: DECIMAL_TYPE, title: 'Number (Decimal)' },
  { key: LINK_TYPE, title: 'URL' },
  { key: SWITCH_TYPE, title: 'True/False (Boolean)' },
  { key: IMAGE_TYPE, title: 'Media (Single)' },
  { key: GALLERY_TYPE, title: 'Media Gallery' },
